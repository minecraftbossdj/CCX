...
public class USBInventory extends SimpleContainer {
    private final USBBlockEntity parent;

    public USBInventory(USBBlockEntity parent, int size) {
        super(size);
        this.parent = parent;
    }
