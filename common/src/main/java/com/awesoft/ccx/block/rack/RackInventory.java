...
public class RackInventory extends SimpleContainer {
    private final RackBlockEntity parent;

    public RackInventory(RackBlockEntity parent, int size) {
        super(size);
        this.parent = parent;
    }
    ...
    public boolean canPlaceItem(int slot, ItemStack stack) {
        return stack.is(CCXItems.SERVER_ADVANCED.get()) || stack.is(CCXItems.SERVER_COMMAND.get()) || stack.is(CCXItems.SERVER_REMOTE.get());
    }
}
